...
curis_data = pd.read_excel('Last year complete export - dois.xlsx', sheet_name=0)
scwos_data = pd.read_excel('Last year complete export - dois.xlsx', sheet_name=3)
...
with pd.ExcelWriter("slutsoegning_2022.xlsx") as writer:
